...
** Date:		7/23/2018
** Description:  This is an implementation file for the file Bedroom1.hpp.
*********************************************************************/
...
void Bedroom1::setBed(bool bedIn)
{
	bed = bedIn;
}

bool Bedroom1::getBed()
{
	return bed;
}
...
void Bedroom1::setDoorLocks(bool lockDoorsIn)
{
	lockDoors = lockDoorsIn;
}


bool Bedroom1::getDoorLocks()
{
	return lockDoors;
}
...
float Bedroom1::roomMenu()
{
	...
	do
	{
		...
		//cout << C2 << "\n\n\n";
		//timer records how long it took the user to enter in a value
		InputTimer = clock() - InputTimer;
		//cout << "The time it took to make a decision was " << InputTimer << " clock ticks.\n";
		
		cout << "\n\n";
	} while (((C2 != 7) && (C2 != 6)) || (fmod(C2, 1) != 0) || (firstChar != '\n'));
