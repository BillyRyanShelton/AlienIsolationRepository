...
** Date:		7/23/2018
** Description:  This is an implementation file for the file Restroom1.hpp.
*********************************************************************/
...
void Restroom1::setAersolCan(bool canIn)
{
	grabAerosolCan = canIn;
}

bool Restroom1::getAersolCan()
{
...
void Restroom1::setShower(bool showerIn)
{
	showerOn = showerIn;
}


bool Restroom1::getShower()
{
	return showerOn;
}
...
float Restroom1::roomMenu()
{
	...
	do
	{
		...
		cout << "\n\n";
	} while (((C2 != 5) && (C2 != 7)) || (fmod(C2, 1) != 0) || (firstChar != '\n'));
