...
** Date:		7/23/2018
** Description:  This is an implementation file for the file LivingRoom1.hpp.
*********************************************************************/
...
void LivingRoom1::setMatches(bool matchesIn)
{
	matches = matchesIn;
}

bool LivingRoom1::getMatches()
{
	return matches;
}
...
void LivingRoom1::setFlowers(bool flowersIn)
{
	tableFlowers = flowersIn;
}


bool LivingRoom1::getFlowers()
{
	return tableFlowers;
}
...
float LivingRoom1::roomMenu()
{
	...
	do
	{
		...
		cout << "\n\n";
	} while (((C2 != 6) && (C2 != 8)) || (fmod(C2, 1) != 0) || (firstChar != '\n'));
